 ...
 ***************************************************************************/
#ifndef FSIGNAL_PciEpn_NODE_H
#define FSIGNAL_PciEpn_NODE_H
#include "FSNode.h"
#include "EventSem.h"
...
namespace fsignal {
    class PciEpnNode : public FSNode {
    public:
        PciEpnNode(const char* propsLoc, std::wstring mainEventID, const char *logFileLoc=NULL);
        ~PciEpnNode(){
            evtSem.Close();
        }
