...
namespace fsignal
{
    ...
    public:
        ...
        DateWrapper(const org::cfn::scad::core::corba::util::Date &d) :
        ...
        short getYear();
        org::cfn::scad::core::corba::util::Date getAsCorbaDate();
        ...
        inline void operator=(const org::cfn::scad::core::corba::util::Date &d){
            day   = d.day;
            month = d.month;
            year  = d.year;
        }                
    ...
    inline org::cfn::scad::core::corba::util::Date DateWrapper::getAsCorbaDate()
    {
