...
namespace fsignal
{
    ...
    public:
        ...
        TimeStampWrapper(const org::cfn::scad::core::corba::util::TimeStamp &ts)
        {
            tw = ts.tm;
            dw = ts.dt;
        }
        ...
        org::cfn::scad::core::corba::util::TimeStamp getAsCorbaTimeStamp();
    ...
    inline org::cfn::scad::core::corba::util::TimeStamp TimeStampWrapper::getAsCorbaTimeStamp()
    {
        using namespace org::cfn::scad::core::corba::util;
        TimeStamp_var ts = new TimeStamp();
        ts->tm = tw.getAsCorbaTime();
        ts->dt = dw.getAsCorbaDate();
...
//        free(now);
    ...
    {
        return getTimeInSeconds() * 1000L + tw.getMillis();
    }

    inline long long TimeStampWrapper::getTimeInMicros()
    {
        return getTimeInMillis() * 1000L + tw.getMicros();
    }

    inline long long TimeStampWrapper::getTimeInNanos()
    {
        return getTimeInMicros() * 1000L + tw.getNanos();
    }
