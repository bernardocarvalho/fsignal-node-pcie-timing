...
wstring CentralTestParameter::AMPLITUDE_ID = L"AMPLITUDE";
wstring CentralTestParameter::FREQUENCY_ID = L"FREQUENCY";
wstring CentralTestParameter::N_POINTS_ID = L"N_POINTS";
wstring CentralTestParameter::TBS_ID = L"TBS";

FieldDataWrapper CentralTestParameter::getValue(const wstring &fieldUniqueID)
{
	stringstream val;
...
void CentralTestParameter::setValue(const FieldDataWrapper &fd)
{
...
void CentralTestParameter::setValues(const vector<FieldDataWrapper> &fdl)
{
	for(unsigned int i=0; i<fdl.size(); i++)
		setValue(fdl[i]);
}

vector<FieldDataWrapper> CentralTestParameter::getValues()
{
