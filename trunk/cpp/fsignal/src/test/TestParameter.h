 ...
 ***************************************************************************/
#ifndef FSIGNAL_TEST_PARAMETER_H
#define FSIGNAL_TEST_PARAMETER_H
...
namespace fsignal
{
    class TestParameter : public FSParameter
    {
    public:
        TestParameter(std::string uniqueID) : FSParameter(uniqueID), amplitude(2), tbs(1), frequency(1), npoints(100000){}
    ...
    inline float TestParameter::getAmplitude()
    {
            return amplitude;
    }

    inline int TestParameter::getTBS()
    {
            return tbs;
    }

    inline int TestParameter::getNPoints()
    {
            return npoints;
    }

    inline int TestParameter::getFrequency()
    {
            return frequency;
    }
}
